...
| `DELETE /entities/{entity_id}` | Interfaces remove an Entity | ID → no body | `delete` Entity; retain historical Object associations; Asset deletion also revokes its bound credentials and closes their feeds | Retain |
