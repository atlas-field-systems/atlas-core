...
- Exact Task/queue field encodings, report ordering and failure behavior during sequential Asset execution; pause/resume and immediate execution need the planned follow-up decision.
