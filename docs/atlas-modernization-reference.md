...
| Cancellation | Historically, `cancelled` records withdrawal without proving physical stop. The successor instead records a separate request and waits for confirmed cancellation of accepted work; see [ADR-0007](adr/0007-reconcile-asset-tasks-after-disconnection.md). | [Task contract][tasking] |
