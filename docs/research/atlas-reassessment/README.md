...
Current design update: [ADR-0014](../../adr/0014-build-dedicated-atlas-systems.md) selects dedicated Atlas systems over an infrastructure-first framework. The [system design](../../architecture/system-design.md) records SDK modes, private Object storage, Asset-owned scheduling and client-independent Plugin Operations. Core is assumed not to restart while Assets operate; cross-restart client continuation is excluded. Earlier research proposals do not override these decisions.
